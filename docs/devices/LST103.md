...
### 페어링
1. 기기에 최소 10초 이상 전원을 공급합니다.
2. 1초 동안 전원을 끊습니다.
3. 1초 동안 기기에 전원을 공급합니다.
4. 2~3단계를 총 4회 반복합니다.
5. 조명 시스템이 모든 색상으로 점멸한 후 중성 흰색으로 돌아오면 초기화가 완료되어 페어링 모드 상태입니다.

*참고:* 페어링이 잘 되지 않는 경우, 라우팅 장치를 조명 시스템 가까이(2~3미터 이내)에 두면 도움이 될 수 있습니다.

마운트 방법(페어링 및 초기화 포함)은 [이 영상](https://www.youtube.com/watch?v=XF0IQhhXPIY)을 참조하세요.
