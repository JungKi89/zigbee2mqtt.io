...
| Prog. 버튼 기능                          |                       |
|-----------------------------------------|-----------------------|
| 초기화 수행 / 게이트웨이와 페어링        | 5번 짧게 누름         |
| Zigbee 네트워크 생성 / 디바이스 연결     | 4번 짧게 누름         |
| Touchlink으로 리모컨 연결               | 4번 짧게 누름         |
| Find & Bind으로 리모컨 연결             | 3번 짧게 누름         |

**주의**: Zigbee2MQTT로 마이그레이션하는 경우 기존 게이트웨이가 아직 실행 중이라면 꺼주십시오. 그렇지 않으면 스위치가 기존 게이트웨이에 계속 연결됩니다.
