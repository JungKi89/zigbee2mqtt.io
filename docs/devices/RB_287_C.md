...
Innr Smart Bulb Colour E27 1200lm 2025년 모델입니다.
제조사 웹페이지는 [여기](https://innr.com/products/innr-smart-bulb-colour-e27-1200lm-2025)에서 확인할 수 있습니다.

## 페어링
전구는 페어링 모드에서 전원을 켠 후 두 번 깜빡입니다. 새 전구는 자동으로 페어링 모드로 진입해야 합니다. 전구는 전원 사이클링 또는 touchlink를 통해 초기화할 수 있습니다.

### 전원 사이클링

제조사 [동영상](https://www.youtube.com/watch?v=o4D6lR5eDoo)에 나온 것처럼 전원을 6번 켰다 끄면 전구를 초기화할 수 있습니다.

### Touchlink

전원을 켠 후 일정 시간 내에 touchlink를 통해 전구를 초기화할 수 있습니다. [Touchlink](../guide/usage/touchlink.md)를 참조하세요. 또는 Innr, Philips Hue, Ikea 등의 touchlink를 지원하는 리모컨으로도 전구를 초기화할 수 있습니다.
