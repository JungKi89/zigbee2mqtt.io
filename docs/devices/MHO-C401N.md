...
원래 이 기기는 Zigbee를 지원하지 않으며 Bluetooth만 지원합니다.
Zigbee2MQTT와 함께 사용하려면 [여기](https://github.com/pvvx/ZigbeeTLc)에 설명된 대로 커스텀 펌웨어를 플래시해야 합니다. 이 펌웨어는 기기를 Bluetooth에서 Zigbee로 변환합니다.
