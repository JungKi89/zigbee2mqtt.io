...
## Notes
제조사 제품 페이지: [링크](https://de.paulmann.com/p/maxled-controller-smart-home-zigbee-3.0-tunable-white-dc-24v-max.-144w-weiss-grau/50046)
...
2. 5번 반복
    1. OFF > 3초
    2. ON < 2초
3. 조명이 10초간 호흡 점멸 -> 페어링 성공/페어링 모드
