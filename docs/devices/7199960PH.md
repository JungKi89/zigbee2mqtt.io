...
### LivingColors 페어링
Philips (HUE) Remote Gen 2 (터치 휠) 또는 Gen 3 (원형 클릭 휠)과 함께 제공되는 Philips LivingColors IRIS 및 Philips LivingColors Bloom 기기는 Zigbee를 통해 페어링할 수 있습니다.
Gen 1 리모컨이 있는 기기는 Zigbee를 사용하지 않으므로 페어링할 수 없습니다.
Philips LivingColors 리모컨은 Zigbee Light Link (ZLL)만 지원하기 때문에 Zigbee를 통해 페어링할 수 없습니다.

리모컨의 ON 버튼과 왼쪽 하단 키(즐겨찾기 1)를 기기 앞에서 기기 조명이 깜박이고 주황색으로 켜질 때까지 누르고 있으세요. 연결에 성공하면 기기 조명이 녹색으로 켜집니다.

**WARNING**: ZLL 채널을 사용하지 않는 Zigbee 네트워크에 기기를 페어링하면 Philips LivingColors Remote Gen 3으로 기기를 초기화할 수 없습니다.
Gen 3 리모컨은 기기를 찾기 위해 ZLL 채널만 시도합니다! Philips LivingColors Remote Gen 2는 모든 Zigbee 채널을 시도하므로 초기화가 가능할 수 있습니다.

IKEA Tradfri 리모컨으로 초기화가 가능할 수 있습니다. [TRADFRI remote control](#tradfri-remote-control) 참고

[Philips LivingColors Bloom 매뉴얼](https://www.download.p4c.philips.com/files/7/7099760pu/7099760pu_dfu_eng.pdf)

[Philips LivingColors Iris 매뉴얼](https://www.download.p4c.philips.com/files/7/7099930ph/7099930ph_dfu_eng.pdf)
