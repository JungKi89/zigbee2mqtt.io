...
## Notes
주의: 일부 Eglo / AwoX 조명은 네트워크 상태를 불안정하게 만드는 것으로 알려져 있습니다. AwoX HomeConnect (Bluetooth)를 통해 펌웨어를 수동으로 업그레이드하면 연결 상태가 개선될 수 있습니다. https://www.zigbee2mqtt.io/advanced/zigbee/02_improve_network_range_and_stability.html#avoid-devices-from-awox
