...
### Home Assistant와의 2-way 미러링

두 SM323 디머가 트래블러 와이어 없이 각자의 ON/OFF 및 밝기를 서로 따라가는 단일 가상 2-way로 동작하게 하려면, Home Assistant용 Samotech SM-series Direct Mirror Pair 블루프린트를 사용할 수 있습니다. ZHA와 Zigbee2MQTT 모두 지원합니다.

[블루프린트 가져오기](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fraw.githubusercontent.com%2Ffidusachates%2Fhome-assistant-blueprints%2Fmain%2Fsamotech-sm-series-direct-mirror-pair.yaml) · [설정 안내](https://www.samotech.co.uk/samotech-direct-mirror-pair-home-assistant)
