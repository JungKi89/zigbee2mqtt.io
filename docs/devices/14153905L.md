...
### 페어링
조명을 끈 다음 각 동작 사이에 1초 간격으로 3번 켭니다.  
켜고 끄는 동작 사이의 간격이 중요합니다. 빠르게 켜고 끄면 페어링 모드로 진입하지 않습니다. 각 켜고 끄기 동작 사이에 "Mississippi"를 발음하는 것이 좋은 방법입니다.
...
11. 켜기
12. 1초 기다리기
13. 이제 장치가 천천히 밝아졌다 어두워지며 페어링 모드로 진입합니다.

성공하지 못하면 켜고 끄기 동작 사이의 시간을 약간 늘리고, 다시 시도하기 전에 몇 초간 꺼두세요.
