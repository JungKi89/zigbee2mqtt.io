...
### 페어링
공장 초기화 방법:
- 바인딩 키를 15초 동안 길게 누릅니다. 네트워크 표시등이 녹색으로 3번 깜박입니다
(3초, 10초, 15초 시점에 각각 깜박입니다).
- 바인딩 키를 놓은 후 2초 이내에 스위치 키를 누릅니다. 네트워크 표시등이
빠르게 녹색으로 깜박입니다.
- 빠른 깜박임 후, Z809A가 재부팅되고 복원이 완료됩니다. 소켓이 자동으로 연결됩니다.
