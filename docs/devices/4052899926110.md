...
전구를 5초 동안 켜세요.
전구를 5초 동안 끄세요.
위 단계를 4번 더 반복하여 총 5번의 OFF/ON 사이클을 수행하세요.
다섯 번째 사이클 후, 조명을 켜고 10초 동안 기다리세요.
전구가 3번 깜박이면 초기화가 완료된 것입니다.

스마트폰의 스톱워치를 활용하면 도움이 됩니다. 전원을 켤 때 스톱워치를 시작하고 50초가 될 때까지 5초마다 전원을 토글하세요. 그런 다음 깜박임을 기다리세요.

조명이 깜박이지 않으면 위 단계를 반복하세요.
