...
### 사용 설명서
[공급업체 사용 설명서](https://www.elektroimportoren.no/docs/lib/89665-Brukerveiledning-5.pdf)

### 페어링
이 Namron Lightstrip을 공장 초기화하는 방법은 여러 가지가 있습니다.
자세한 지침은 첨부 링크의 사용 설명서를 참고하세요.
