...
### 페어링
먼저 초기화합니다. 두 버튼을 5초간 누르고 있으면 LED가 켜집니다(파란색 또는 녹색으로 지속). 그런 다음 "0"을 5번 누릅니다. (모델에 따라 초당 2회 또는 초당 5회 속도로) 그런 다음 페어링합니다. 두 버튼을 다시 5초간 누르고 있으면 LED가 켜집니다. 그런 다음 "|"를 한 번 누르면 페어링 모드로 진입하여 깜빡이기 시작합니다. 연결되지 않으면 두 번째 단계를 다시 시도합니다.
