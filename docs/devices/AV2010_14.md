...
### 페어링
SMaBiT AV2010/14 센서를 코디네이터 가까이에 놓고 전면의 표시등/버튼을 약 10초간 눌러 Zigbee2MQTT와 페어링하세요. 표시등/버튼이 빨간색으로 한 번 깜빡이면 페어링 모드에 진입한 것입니다. 이제 Zigbee2MQTT 기기 목록에서 SMaBiT AV2010/22 센서가 표시되어야 합니다.
