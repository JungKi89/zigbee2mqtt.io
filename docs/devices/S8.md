...
## Notes
이 핸들은 [SODA GmBh](https://soda-gmbh.de/)의 제품으로 [Amazon Germany](https://www.amazon.de/sp?ie=UTF8&isAmazonFulfilled=0&marketplaceSeller=1&seller=AS4J66PXH3SHW)에서 판매됩니다.

[문서/매뉴얼](https://soda-gmbh.de/assets/download/S8_Premium_Anleitung.pdf)

### 페어링 및 초기화
* 페어링하려면 배터리를 삽입하면서 왼쪽 버튼을 누릅니다.

* 초기화하려면 배터리를 삽입하면서 두 버튼을 모두 누릅니다.
