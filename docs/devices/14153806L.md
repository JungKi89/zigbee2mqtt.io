...
### 페어링
공장 초기화하려면 전원을 3번 끄고 켭니다. 이후 LED 패널이 페어링 모드에서 천천히 깜빡입니다.

### 색온도
이 장치는 색온도 변경을 지원하지 않습니다([제조사 확인](https://github.com/Koenkk/zigbee2mqtt/issues/14439#issuecomment-1363813244)). 색온도를 변경하면 4000K의 밝은 백색 LED가 켜집니다.
