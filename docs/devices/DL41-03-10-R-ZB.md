...
1. UI에서 페어링 모드를 활성화하세요.
1. 조명 전원을 켜세요.
1. 허브가 일정 시간 후에도 연결되지 않으면 초기화 방법을 참고하세요.
...
1. 기기 전원을 켜세요.
1. 2초 이내에 전원을 껐다 켜세요.
1. 전원 끄기/켜기를 세 번 반복하세요.
1. 세 번째 전원을 켤 때 기기가 완전히 켜지고 네 번 깜빡이면 초기화가 완료됩니다. 깜빡이지 않으면 4~5번 시도해 보고 전원 사이클 사이에 더 오래 기다려 보세요.
