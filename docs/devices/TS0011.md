...
## Notes
이 디바이스는 Zigbee 라우터로 동작하지 않습니다.


### 리브랜드
영국에서는 중성선이 필요 없는 버전으로 Yagusmart라는 이름으로도 판매됩니다.


### 바인딩 및 그룹
`manufacturerName`이 `_TYZB01_qeqvmvti`인 디바이스는 바인딩 및 그룹을 지원하지 않습니다 ([링크](https://github.com/Koenkk/zigbee2mqtt/issues/5225)).
