...
- W 키를 5초간 누릅니다.
- Power On/Off 키를 3초간 누릅니다.
공장 초기화가 성공하면 디바이스가 10번 점멸해야 합니다.

### 페어링

- W 키를 3초간 누릅니다.
- Power On/Off 키를 5초간 누릅니다.
- Power On/Off를 다시 3초간 누릅니다.
이제 디바이스가 표시되어야 합니다.

### 확장 색조(Extended hue)

이 디바이스는 확장 색조 값을 제공합니다. Zigbee2MQTT는 일반 색조도 계산하여 MQTT를 통해 두 값 모두 제공합니다.
