...
* 9단계: 5초간 켭니다.
* 10단계: 5초간 끕니다.
* 11단계: 켜고 켜진 상태를 유지합니다. 조절 가능한 전구가 2번 깜빡이면 초기화 성공 및 페어링 준비가 완료된 것입니다.

이제 전구가 네트워크에 표시되며 페어링할 수 있습니다.
초기화 후 전구는 자동으로 연결됩니다.

출처: [Manual reset](https://www.belkin.com/support-article/?articleNum=159344)의 지침을 따르세요.
