...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", null, [
		...
		createBaseVNode("ul", null, [
			createBaseVNode("li", null, [createVNode(_component_RouteLink, { to: "/en/guide/installation/01_linux.html" }, {
				default: withCtx(() => [..._cache[0] || (_cache[0] = [createTextVNode("Linux", -1)])]),
				_: 1
			})]),
			createBaseVNode("li", null, [createVNode(_component_RouteLink, { to: "/en/guide/installation/02_docker.html" }, {
				default: withCtx(() => [..._cache[1] || (_cache[1] = [createTextVNode("Docker", -1)])]),
				_: 1
			})]),
			createBaseVNode("li", null, [createVNode(_component_RouteLink, { to: "/en/guide/installation/03_ha_addon.html" }, {
				default: withCtx(() => [..._cache[2] || (_cache[2] = [createTextVNode("Home Assistant addon", -1)])]),
				_: 1
			})]),
			createBaseVNode("li", null, [createVNode(_component_RouteLink, { to: "/en/guide/installation/04_openhabian.html" }, {
				default: withCtx(() => [..._cache[3] || (_cache[3] = [createTextVNode("openHABian", -1)])]),
				_: 1
			})]),
			createBaseVNode("li", null, [createVNode(_component_RouteLink, { to: "/en/guide/installation/05_windows.html" }, {
				default: withCtx(() => [..._cache[4] || (_cache[4] = [createTextVNode("Windows", -1)])]),
				_: 1
			})]),
			createBaseVNode("li", null, [createVNode(_component_RouteLink, { to: "/en/guide/installation/06_freebsd_jail.html" }, {
				default: withCtx(() => [..._cache[5] || (_cache[5] = [createTextVNode("FreeBSD jail", -1)])]),
				_: 1
			})]),
			createBaseVNode("li", null, [createVNode(_component_RouteLink, { to: "/en/guide/installation/08_kubernetes.html" }, {
		...
		createBaseVNode("ul", null, [createBaseVNode("li", null, [createVNode(_component_RouteLink, { to: "/en/guide/installation/15_watchdog.html" }, {
		...
		createBaseVNode("ul", null, [createBaseVNode("li", null, [createVNode(_component_RouteLink, { to: "/en/guide/installation/20_zigbee2mqtt-fails-to-start_crashes-runtime.html" }, {
