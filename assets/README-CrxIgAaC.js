...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", null, [
		_cache[9] || (_cache[9] = createBaseVNode("h1", {
			...
			class: "header-anchor",
			href: "#설치"
		}, [createBaseVNode("span", null, "설치")])], -1)),
		_cache[10] || (_cache[10] = createBaseVNode("p", null, "Zigbee2MQTT는 Node.js로 작성되었으며, 적은 메모리로 거의 모든 플랫폼에서 실행할 수 있습니다.", -1)),
		...
		_cache[11] || (_cache[11] = createBaseVNode("h2", {
			...
			class: "header-anchor",
			href: "#선택-사항"
		}, [createBaseVNode("span", null, "선택 사항")])], -1)),
		...
		_cache[12] || (_cache[12] = createBaseVNode("h2", {
			...
			class: "header-anchor",
			href: "#문제-해결"
		}, [createBaseVNode("span", null, "문제 해결")])], -1)),
		createBaseVNode("ul", null, [createBaseVNode("li", null, [createVNode(_component_RouteLink, { to: "/guide/installation/20_zigbee2mqtt-fails-to-start_crashes-runtime.html" }, {
			default: withCtx(() => [..._cache[8] || (_cache[8] = [createTextVNode("Zigbee2MQTT 시작 실패/런타임 충돌", -1)])]),
			_: 1
		})])])
	]);
}
